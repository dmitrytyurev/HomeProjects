...
#pragma warning(suppress : 4996)
  ...
  BYTE *color_bmp;           // óêàçàòåëü íà bmp-ôàéë òåêñòóðû, îòìýïëåííûé íà ïàìÿòü
  int map_size_x_aligned;    // ðàññòîÿíèå ìåæäó ñòðîêàìè òåêóùåé BMP-òåêñòóðû
  int bytesDepth;            // ãëóáèíà öâåòà òåêñòóðû â áàéòàõ(!).  3 èëè 4 (ñ àëüôà-êàíàëîì)
  int x_size, y_size;        // ðàçìåð îòêðûòîé òåêñòóðû

  //--------------------------------------------------------------------------------------------
  // Ôóíêöèè äëÿ ðàáîòû ñ BMP
  //--------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------
  // Ïî èìåíè ôàéëà êàðòèíêè âåðíóòü å¸ ðàçìåðû è áèòíîñòü
  //--------------------------------------------------------------------------------------------
...
void read_bmp24(const char* fileName, unsigned char* pixels)
{
  ...
  //--------------------------------------------------------------------------------------------
  // Îòêðûòü êàðòèíêó â ðåæèìå îòîáðàæåíèÿ íà ïàìÿòü 
  // Äîñòóï îñóùåñòâëÿåòñÿ ÷åðåç ôóíêöèþ give_pixel_adr
  // Ïî îêîí÷àíèè ðàáîòû çàêðûòü ôàéë ôóíêöèåé close_color_bmp
  //--------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------
  // Çàêðûòü êàðòèíêó, îòêðûòóþ ôóíêöèåé open_color_bmp
  //--------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------
  // Âîçâðàùàåò àäðåñ çàäàííîãî ïèêñåëà îòêðûòîãî ôàéëà
  // Ìîæíî ÷èòàòü âñþ ñòðîêó äî êîíöà
  //--------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------
  // Çàïèñûâàåò ïåðåäàííûé ìàññèâ DWORD'îâ, êàê BMP32
  //--------------------------------------------------------------------------------------------
  ...
  void save_bmp32(const char *name, int sizeX, int sizeY, const char *data)
  {
    ...
    int endLineSize = pitch - sizeX * 4;              // äëèíà äîïèñêè â êîíåö êàæäîé ñòðîêè (âûðàâíèâàíèå íà ãðàíèöó 4)
    int endFileSize = size - (54 + sizeY * pitch);      // äëèíà äîïèñêè â êîíåö ôàéëà (âûðàâíèâàíèå íà ãðàíèöó 4)
 ...
 //--------------------------------------------------------------------------------------------
// Çàïèñûâàåò ïåðåäàííûé ìàññèâ DWORD'îâ, êàê BMP24
//--------------------------------------------------------------------------------------------
  ...
  void save_bmp24(const char *name, int sizeX, int sizeY, const char *data)
  {
	  ...
	  int size = odd4(54 + sizeY * pitch);
	  int endLineSize = pitch - sizeX * 3;              // äëèíà äîïèñêè â êîíåö êàæäîé ñòðîêè (âûðàâíèâàíèå íà ãðàíèöó 4)
	  int endFileSize = size - (54 + sizeY * pitch);      // äëèíà äîïèñêè â êîíåö ôàéëà (âûðàâíèâàíèå íà ãðàíèöó 4)
