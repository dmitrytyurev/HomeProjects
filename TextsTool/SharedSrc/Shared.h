...
namespace AttributePropertyType // Тип данных атрибута таблицы. Часть типов используется для сериализации/десериализации, часть типов для отображения данных в таблице
{
	enum : uint8_t
	{
